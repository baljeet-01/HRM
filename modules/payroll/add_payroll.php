...
$list = $class_pay->get_employees_in_notin_payroll('NOT IN');
?>
        ...
        <div class="container">
              <form id="payrollRegistration" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                ...
                <fieldset class="border p-2">
                  ...
                  <input type="submit" value = "<?php echo $LNGsave ?>" class="btn btn-primary float-right mt-3" id="add_payroll">
              </form>
        </div>  
